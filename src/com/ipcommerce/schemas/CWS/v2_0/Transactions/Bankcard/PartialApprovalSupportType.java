...
public class PartialApprovalSupportType implements java.io.Serializable {
    ...
    public static final PartialApprovalSupportType NotSet = new PartialApprovalSupportType(_NotSet);
    public static final PartialApprovalSupportType Capable = new PartialApprovalSupportType(_Capable);
    public static final PartialApprovalSupportType NotCapable = new PartialApprovalSupportType(_NotCapable);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard", "PartialApprovalSupportType"));
    }
    /**
