...
public class Capture  implements java.io.Serializable {
    /* <summary>
     *             Transaction ID of the authorization to capture. Required.
     * </summary> */
    ...
    /**
     * Gets the transactionId value for this Capture.
     * 
    ...
    /**
     * Sets the transactionId value for this Capture.
     * 
    ...
    /**
     * Gets the addendum value for this Capture.
     * 
    ...
    /**
     * Sets the addendum value for this Capture.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions", "Capture"));
