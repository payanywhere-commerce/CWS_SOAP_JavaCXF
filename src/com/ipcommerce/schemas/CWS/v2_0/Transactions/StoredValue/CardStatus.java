...
public class CardStatus implements java.io.Serializable {
    ...
    public static final java.lang.String _RemoveStatus = "RemoveStatus";
    public static final CardStatus NotSet = new CardStatus(_NotSet);
    public static final CardStatus Lost = new CardStatus(_Lost);
    public static final CardStatus Stolen = new CardStatus(_Stolen);
    public static final CardStatus Suspended = new CardStatus(_Suspended);
    public static final CardStatus RemoveStatus = new CardStatus(_RemoveStatus);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions/StoredValue", "CardStatus"));
    }
    /**
