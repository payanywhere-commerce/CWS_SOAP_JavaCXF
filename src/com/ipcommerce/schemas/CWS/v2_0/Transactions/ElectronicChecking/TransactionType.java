...
public class TransactionType implements java.io.Serializable {
    ...
    public static final TransactionType Credit = new TransactionType(_Credit);
    public static final TransactionType Debit = new TransactionType(_Debit);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions/ElectronicChecking", "TransactionType"));
    }
    /**
