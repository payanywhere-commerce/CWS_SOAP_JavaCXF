...
public class ServiceType implements java.io.Serializable {
    ...
    public static final java.lang.String _ECK = "ECK";
    public static final java.lang.String _RDC = "RDC";
    public static final ServiceType NotSet = new ServiceType(_NotSet);
    public static final ServiceType ACH = new ServiceType(_ACH);
    public static final ServiceType ECK = new ServiceType(_ECK);
    public static final ServiceType RDC = new ServiceType(_RDC);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions/ElectronicChecking", "ServiceType"));
    }
    /**
