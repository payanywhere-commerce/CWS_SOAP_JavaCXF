...
public class QueryType implements java.io.Serializable {
    ...
    // Constructor
    protected QueryType(java.lang.String value) {
        _value_ = value;
    ...
    public static final QueryType AND = new QueryType(_AND);
    public static final QueryType OR = new QueryType(_OR);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.ipcommerce.com/CWS/v2.0/DataServices/TMS", "QueryType"));
    }
    /**
