...
public class main_Vantiv_Tandem {
	
	public static void main(String args[]) throws Exception {
		SampleApp_Vantiv_Tandem SA = new SampleApp_Vantiv_Tandem();
	...
	///Service Information 
		...
		*/
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/SOAP_Developer_Guide/2.0.17/Implementation/PreparingTheAppToTransact/RetrievingServiceInformation.aspx
		*/
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/SOAP_Developer_Guide/2.0.17/Implementation/PreparingTheAppToTransact/ManagingMerchantProfiles/index.aspx
		*/
	...
	///BankcardService Transactions
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/SOAP_Developer_Guide/2.0.17/Implementation/TransactionProcessing/AuthorizingTransactions/index.aspx
		*/
		if(!SA.AuthorizeAndCapture(CV))return; //Results displayed in the console
//DB Note that Restaurant does not support Authorize
//if(!SA.Authorize(CV))return; //Results displayed in the console
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/SOAP_Developer_Guide/2.0.17/Implementation/TransactionProcessing/AdjustingVoidingTransactions/index.aspx
		*/
		if(!SA.Adjust(CV))return; //Results displayed in the console
//DB Note that Restaurant does not support Authorize so Undo is not possible
//if(!SA.Undo(CV))return; //Results displayed in the console
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/SOAP_Developer_Guide/2.0.17/Implementation/TransactionProcessing/CapturingTransactions/index.aspx
		*/
//DB Note that Restaurant does not support Authorize so Undo is not possible
//		if(!SA.Capture(CV))return; //Results displayed in the console
//DB NOTE : Restaurant requires CaptureAll
...
//		if(!SA.CaptureSelective(CV))return; //Results displayed in the console
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/SOAP_Developer_Guide/2.0.17/Implementation/TransactionProcessing/RefundingTransactions/index.aspx
		*/
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/SOAP_Developer_Guide/2.0.17/Implementation/TransactionProcessing/OptionalOperations/index.aspx
		*/
